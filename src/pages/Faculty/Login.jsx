    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center p-4 font-sans">
        <div className="bg-white rounded-lg shadow-xl p-8 max-w-6xl w-full">
          ...
          The Faculty OD Request and Approval Module was developed as part of a summer internship project. It is designed to streamline and digitize the official duty (OD) request and approval process for faculty members involved in academic and institutional activities such as courses, workshops, training programs, FDPs, STTPs, conferences, industrial visits, publications, and university representation. The module also supports confidential report generation and department-level data consolidation through a centralized and user-friendly interface.
          </p>
          ...
          <div className="flex flex-row justify-center gap-6 font-sans">
            {/* Card 1 */}
            <div className="flex flex-col items-center bg-white rounded-lg shadow-md p-6 w-48 min-w-[12rem] font-sans">
              <div className="w-28 h-28 bg-gray-200 rounded-full mb-4 flex items-center justify-center">
                {/* Image placeholder */}
              </div>
              <div className="text-lg font-semibold text-center mb-2 font-sans">VISVESSWAR</div>
              <div className="text-sm text-gray-600 text-center font-sans">B.E. Computer Science and Engineering, 4rth Year</div>
            </div>
            {/* Card 2 */}
            <div className="flex flex-col items-center bg-white rounded-lg shadow-md p-6 w-48 min-w-[12rem] font-sans">
              <div className="w-28 h-28 mb-4 flex items-center justify-center overflow-hidden">
                <img src="/nikhitaa.jpeg" alt="Nikhitaa M" className="object-cover object-center w-28 h-28 rounded-full p-1" />
              </div>
              <div className="text-lg font-semibold text-center mb-2 font-sans">NIKHITAA M</div>
              <div className="text-sm text-gray-600 text-center font-sans">B.E. Computer Science and Engineering, 3rd Year</div>
            </div>
            {/* Card 3 */}
            <div className="flex flex-col items-center bg-white rounded-lg shadow-md p-6 w-48 min-w-[12rem] font-sans">
              <div className="w-28 h-28 mb-4 flex items-center justify-center overflow-hidden">
                <img src="/sainikitha.jpeg" alt="Sainikitha I" className="object-cover object-center w-28 h-28 rounded-full p-1" />
              </div>
              <div className="text-lg font-semibold text-center mb-2 font-sans">SAINIKITHA I</div>
              <div className="text-sm text-gray-600 text-center font-sans">B.E. Computer Science and Engineering, 3rd Year</div>
            </div>
            {/* Card 4 */}
            <div className="flex flex-col items-center bg-white rounded-lg shadow-md p-6 w-48 min-w-[12rem] font-sans">
          ...
          This portal was built during a summer internship during June 2025 by students from the Department of Computer Science and Engineering, Anna University.
          </p>
